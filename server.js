...
const privateKey = fs.readFileSync('Certificado_SSL\\certificado_publico.pem', 'utf8');
const certificate = fs.readFileSync('Certificado_SSL\\certificado_publico.', 'utf8');
